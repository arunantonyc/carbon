...
function sendLogin(key, name, password) {
    var src = {
        'k': key,
        'n': name,
        'p': password
    ...
    $.ajax({
        ...
        success: function (reply) {
            //var data = JSON.parse(reply);
            //alert("Logged In");
            $("#partialLoginKey").text(key);
            $("#main-userKey").val(key);
...
$(document).ready(function () {
    ...
    if (loginKey == null) {
        $('#logoutSubmit').hide();
        $('#loginDetail').modal('show');
    }
    $("#main-userKey").val(loginKey);
    ...
    $('body').on('click', '#partialLoginKey', function () {
        $('#loginDetail').modal('show');
    });

    $('#loginSubmit').click(function () {     
        var newloginKey = $("#modal-loginKey").val();
        sendLogin(newloginKey, '', '');
                
    });

    $('body').on('click', '#skipSubmit', function () {
        $('#loginDetail').modal('hide');
    });
});
